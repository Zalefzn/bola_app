...
import 'package:soccer_app/screen/cardPage/cardStadium.dart';
...
class HomePageStadium extends StatefulWidget {
  const HomePageStadium({Key? key}) : super(key: key);

  @override
  State<HomePageStadium> createState() => _HomePageStadium();
}

class _HomePageStadium extends State<HomePageStadium> {
  var username;
  var favoriteClub;
  var city;
  bool _folded = true;
  ...
  Widget build(BuildContext context) {
    ...
    onSearchTextChanged(String text) async {
      ...
      clubProvider.clubs.forEach((data) {
        if (data.stadiumName.toLowerCase().contains(text) ||
              ...
              child: SingleChildScrollView(
                child: Column(
                    children: clubProvider.search.length != 0 ||
                        ...
                        ? clubProvider.search
                            .map((stadium) => StadiumCard(stadium))
                            .toList()
                        : clubProvider.clubs
                            .map((stadium) => StadiumCard(stadium))
                            .toList()),
